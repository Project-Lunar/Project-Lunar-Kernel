...
extern int write_panic_data(struct _nftl_blk *nftl_blk,uint32 start_sector, uint32 sector_num, uchar *buf);
...
*Note         :
*****************************************************************************/
int panic_dev_nand_read(struct _nand_dev *nand_dev, __u32 start_sector,
...
int critical_dev_nand_write(uchar *dev_name, __u32 start_sector, __u32 sector_num, uchar *buf)
{
	...
	ret = write_panic_data(nand_dev->nftl_blk,start_sector + nand_dev->offset, sector_num, buf);
