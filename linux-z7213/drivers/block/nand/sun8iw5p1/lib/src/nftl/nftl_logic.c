...
*Note         :
*****************************************************************************/
int _nftl_discard_logic_page(struct _nftl_zone* zone,uint32 page_no)
{
    int ret;
    
    ret = write_data_to_page(zone,PHY_DISCARD_INFO_PAGE,page_no,NULL);
...
void nftl_ops_init(struct _nftl_zone *zone)
{
    ...
    zone->nftl_nand_discard_logic_page = _nftl_discard_logic_page;
