...
void print_smart(void * _zone)
{
    ...
    NFTL_DBG("[NE]smart->total_recv_discard_sectors:%lld;\n",smart->total_recv_discard_sectors);
    NFTL_DBG("[NE]smart->total_real_discard_sectors:%lld;\n",smart->total_real_discard_sectors);
