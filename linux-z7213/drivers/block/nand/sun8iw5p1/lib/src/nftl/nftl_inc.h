...
GLOBAL uint32 nand_discard(struct _nftl_zone* zone,uint32 start_sector,uint32 len);
GLOBAL uint32 __nand_discard(struct _nftl_zone* zone,uint32 start_sector,uint32 len);
GLOBAL uint32 print_logic_page_map(struct _nftl_zone *zone,uint32 start_page);
GLOBAL uint32 get_cold_logic_page(struct _nftl_zone *zone,uint32 start_page,uint32 total_pages);
GLOBAL int read_reclaim(struct _nftl_blk *start_blk,struct _nftl_blk *nftl_blk,uchar*buf,uint32 utc);
GLOBAL struct _nftl_blk* get_nftl_need_read_claim(struct _nftl_blk* start_blk,uint32 utc);
GLOBAL uint32 set_nftl_read_claim_complete(struct _nftl_blk* start_blk,struct _nftl_blk* nftl_blk,uint32 utc);
...
GLOBAL int _nand_discard(struct _nftl_blk *nftl_blk,uint32 start_sector,uint32 len);
...
GLOBAL uint32 nftl_discard(uint32 start_sector,uint32 len);
